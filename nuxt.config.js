  ...
  head: {
    ...
    meta: [
      ...
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        ...
        name: "description",
        content:
          "16 Jahre Jung, Webdesigner aus Augustusburg, Sachsen ist meine Heimat."
      }
    ],
    script: [
      {
      ...
      {
        src:
          "https://cdnjs.cloudflare.com/ajax/libs/smoothscroll/1.4.9/SmoothScroll.min.js"
      },
      {
        src: "https://apex.uwe-barthel.net/scripts/scroll.js"
      },
      {
